...
def get_split(split_name, dataset_dir, file_pattern, reader,
    ...
    #file_pattern = tf_records/voc_2007_train_*.tfrecord
    ...
    输入：data_sources = file_pattern = tf_records/voc_2007_train_*.tfrecord
         ...
         items_to_descriptions:描述项（image,shape,object/bbox,object/label）
         num_classes = NUM_CLASSES = 20
         labels_to_names：labels_to_names = dataset_utils.read_label_file(dataset_dir)
    """
